...
class UserController extends Swift_Controller_Action
{
	...
	public function exportcsvAction(){
        		...
        		if($this->getRequest()->isPost()){
	        		...
	        		foreach($records AS $record){
	        			...
	        			if(trim($record->acct) <> ''){ $acctNumber = $this->formatMumberAccount($record->acct); } else { $acctNumber = $this->formatMumberAccount($record->account_number); }
	        			
	        			if(trim($record->acct_two) <> ''){ $acctNumberTwo = $this->formatMumberAccount($record->acct_two); } else { $acctNumberTwo = $this->formatMumberAccount($record->account_number_two); }
	        			
	        			if(trim($record->payrate) <> '' && $record->payrate <> NULL){ $payrateNumber = $record->payrate; } else { $payrateNumber = $record->spayrate; }
						
	        			$l_form = 'No';
	        			if($record->leave_form == '1'){ $l_form = 'Yes'; }
						if($record->leave_form == '0'){ $l_form = 'No'; }
	...
	{		
		...
		if(isset($letters[1])){$account_number = $account_number."-".$letters[1]; }
		if(isset($letters[2])){ $account_number .= $letters[2]; }
		if(isset($letters[3])){ $account_number .= $letters[3]; }
		if(isset($letters[4])){ $account_number .= "-".$letters[4]; }
		if(isset($letters[5])){ $account_number .= "-".$letters[5]; }
		if(isset($letters[6])){ $account_number .= $letters[6]; }
		if(isset($letters[7])){ $account_number .= $letters[7]; }
		if(isset($letters[8])){ $account_number .= $letters[8]; }
		if(isset($letters[9])){ $account_number .= "-".$letters[9]; }
		if(isset($letters[10])){ $account_number .= $letters[10]; }
		if(isset($letters[11])){ $account_number .= $letters[11]; }
		if(isset($letters[12])){ $account_number .= $letters[12]; }
		if(isset($letters[13])){ $account_number .= "-".$letters[13]; }
		if(isset($letters[14])){ $account_number .= $letters[14]; }
		if(isset($letters[15])){ $account_number .= $letters[15]; }
		if(isset($letters[16])){ $account_number .= $letters[16]; }
		if(isset($letters[17])){ $account_number .= $letters[17]; }
		if(isset($letters[18])){ $account_number .= "-".$letters[18]; }
		if(isset($letters[19])){ $account_number .= $letters[19]; }
		if(isset($letters[20])){ $account_number .= $letters[20]; }
		if(isset($letters[21])){ $account_number .= $letters[21]; }
		if(isset($letters[22])){ $account_number .= "-".$letters[22]; }		
